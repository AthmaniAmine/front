...
function SectionTwo() {
  ...
  return (
    <div className="container w-full md:pb-12  pt-6">
    <div className="flex justify-around items-center gap-4 border-b">
      {services.map((service, index) => (
        ...
        >
          ...
          <span className="md:text-base text-xs font-semibold mt-1">{service.title}</span>
        </div>
      ))}
    </div>
  
    {/* Affichage du service sélectionné */}
    <div className="md:py-12 py-4 md:pb-16 pb-2">
      <div className="grid md:grid-flow-row md:grid-cols-[2fr_1.6fr]  ">
        <div>
          <h1 className="text-2xl font-bold pb-6 pt-6 ">
            {services[selectedService].title}
          </h1>
          <div className="flex flex-col gap-5 md:text-xl text-base font-medium">
        ...
        <div className="pl-10 pt-4">
          <img
            ...
            className="md:w-full md:h-auto w-0 h-0 rounded-lg shadow-lg"
          />
        </div>
      </div>
    </div>
