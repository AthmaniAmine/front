...
function AdvancedSearch() {
  ...
  return (
    <div className="container relative z-40 top-[-360px] md:top-[-110px] left-[36px]">
      <div className=" md:h-20 h-[340px] border border-gray-200 rounded-2xl md:rounded-full grid grid-cols-2 md:grid-cols-5 gap-5 md:flex md:items-center md:justify-between md:gap-2  md:px-12 px-12 md:py-14 py-10  absolute bg-white text-sm lg:text-base left-0">
        {/* Localisation */}
        ...
        <div className="relative flex flex-col justify-between ">
          ...
          <div
            className={`absolute bottom-[-70px] z-30 lg:bottom-[-80px] w-[200%] md:w-[300px] lg:w-[400px] px-4 lg:px-6 py-2 lg:py-3 h-16 lg:h-20 border-gray-300  border bg-white  rounded-full ${
              !isShown && `opacity-0`
