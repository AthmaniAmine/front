    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-white p-7 rounded-lg shadow-lg w-[740px] h-[560px] overflow-y-auto">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="grid grid-cols-2 gap-4 py-1">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-gray-400">{devis.datelimit}</p>
            </div>
            <div className="flex flex-col gap-1">
              <p className="font-bold">Budget</p>
              <p className="text-gray-400">{devis.budget} DA</p>
            </div>
          </div>
          <div className="flex flex-col gap-1">
        ...
        <div className="flex justify-end mt-6">
          <button onClick={onClose} className="px-4 py-2 text-white bg-red-600 hover:bg-red-700 rounded-md font-semibold">
            Fermer
          </button>
        </div>
      </div>
